...
import { Rocket, Users, Target, Brain, TrendingUp, Map, ArrowLeft } from 'lucide-react'; // Import ArrowLeft icon
import { useAuth } from '../auth/context/AuthContext';
import { toast } from 'sonner';

/**
 * @typedef {{ onUserTypeChange?: (userType: string) => void, onGoBack?: () => void }} LoginPageProps
 */
/**
 * LoginPage component
...
export default function LoginPage(props) {
  const { onUserTypeChange, onGoBack } = props || {};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden relative">
      ...
      {onGoBack && (
        <motion.button
          onClick={onGoBack}
          className="absolute top-8 left-8 z-20 p-3 rounded-full bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 transition-colors flex items-center justify-center"
